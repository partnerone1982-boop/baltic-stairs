...
export default function SpiralProjectGallery({ project }: { project: (typeof spiralProjects)[number] }) {
  return (
    <section id={project.id} aria-labelledby={`${project.id}-title`} className="mt-12">
      ...
      <div className="mt-4 text-sm text-[#967020]"><Link href="/vintovye-lestnicy" className="underline underline-offset-4">Винтовой металлический каркас</Link></div>
